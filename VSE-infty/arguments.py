...
def get_argument_parser():
    ...
    parser.add_argument('--txt_adapter_name', default='none', type=str,
                        help='Adapter_name_for_text_encoder')
    parser.add_argument('--txt_fusion_name', default='ave', type=str,
                        help='How to compress text word features')
    parser.add_argument('--txt_downsample_D_factor', default=2, type=int,
                        help='Step of hidden-size-based pooling (according to final feature output)')

    # --------------------- image adapter arguments ------------------------ #
    parser.add_argument('--img_adapter_name', default='none', type=str,
                        help='Adapter_name_for_image_encoder')
    parser.add_argument('--img_fusion_name', default='ave', type=str,
                        help='How to compress image grid features')
    parser.add_argument('--img_downsample_D_factor', default=2, type=int,
                        help='Step of hidden-size-based pooling (according to final feature output)')
