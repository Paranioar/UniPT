    ...
    for name, params in model.named_parameters():
        if "adapter" in name:
            ...
            if ('LayerNorm' in name) or ('bias' in name):
                no_decay_noclip_param_tp.append(params)
            else:
                decay_noclip_param_tp.append(params)
        else:
            params.requires_grad = False

    weight_decay = 0.2
    optimizer_grouped_parameters = [
        {'params': decay_clip_param_tp, 'weight_decay': weight_decay, 'lr': args.lr * coef_lr},
        {'params': decay_noclip_param_tp, 'weight_decay': weight_decay},
        {'params': no_decay_clip_param_tp, 'weight_decay': 0.0, 'lr': args.lr * coef_lr},
        {'params': no_decay_noclip_param_tp, 'weight_decay': 0.0}
    ]
